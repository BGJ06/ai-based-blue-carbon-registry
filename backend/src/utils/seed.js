...
const seedData = async () => {
  try {
    ...
    const demoUsers = [
      ...
      {
        name: 'Forest Conservation NGO',
        email: 'info@forestngo.org',
        password: hashedPassword,
        role: 'developer',
        status: 'active',
        verification: { isEmailVerified: true },
        organization: {
          ...
          type: 'NGO',
          registrationNumber: 'NGO987654321'
        }
      },
      {
        name: 'Carbon Verifier',
        email: 'verifier@carboncheck.com',
        password: hashedPassword,
        role: 'verifier',
        status: 'active',
        verification: { isEmailVerified: true },
    ...
    console.log('- contact@greenenergy.com (Corporate Developer)');
    console.log('- info@forestngo.org (NGO Developer)');
    console.log('- verifier@carboncheck.com (Verifier)');
